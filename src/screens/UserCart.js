            ...
            <View style={styles.container}>
                                    ...
                                    <View style={styles.cartcard}>
                                        ...
                                        <View style={styles.cartcardin}>
                                            <View style={styles.c1}>
                                                ...
                                                <Text style={styles.txt2}>ETB {item.data.foodPrice}/each</Text>
                                            </View>
                                            {item.Addonquantity > 0 &&
                                                <View style={styles.c2}>
                                                    <Text style={styles.txt3}>{item.Addonquantity}&nbsp;{item.data.foodAddon}</Text>
                                                    <Text style={styles.txt3}>ETB {item.data.foodAddonPrice}/each</Text>
                                                </View>}
                ...
                <View style={styles.btncont}>
                    <View style={styles.c3}>
                        ...
                        <Text style={styles.txt6}>{totalCost} ETB </Text>
                    </View>
